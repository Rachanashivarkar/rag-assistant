...
- ✅ Works **fully offline** — no API keys or internet required
...
├── data.txt              # Your sample text/document file
├── requirements.txt      # Dependencies list
└── README.md             # Project description

🧠 How It Works

Loads your .txt document using LangChain’s TextLoader.

Converts text into embeddings using Sentence-BERT (Hugging Face).

Stores embeddings in a Chroma vector database for similarity search.

Retrieves relevant chunks and generates contextual answers based on your query.
...
The assistant will respond intelligently based on your document’s content.
